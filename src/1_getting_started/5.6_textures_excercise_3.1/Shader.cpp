...
void Shader::SetInt(const std::string& parameterName, int32_t value)
{
    int32_t parameterLocation = glGetUniformLocation(ShaderId, parameterName.c_str());
    glUniform1i(parameterLocation, value);
}

void Shader::SetVec2(const std::string& parameterName, vec2 value)
{
    int32_t parameterLocation = glGetUniformLocation(ShaderId, parameterName.c_str());
    glUniform2f(parameterLocation, value.x, value.y);
}
